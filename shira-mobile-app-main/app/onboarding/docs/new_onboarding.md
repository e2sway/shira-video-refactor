...
## Overview
This document outlines the implementation plan for rebuilding the onboarding flow for Shira language learning app. The new flow will have a more comprehensive user journey with 15 steps, focusing on personalization, UX education, and user preference collection.
...
#### Shared Components:
1. **ProgressBar** - For question sequence (steps 8-14)
...
3. `GoalSelectionScreen.tsx` (Step 3)
   - Create multiple choice UI for main goals
   - Implement the "What's Driving You to Learn?" question
   - Options include travel, career, study, friends, personal growth
   - Store selection in context
...
8-12. `SurveyQuestionScreen.tsx` (Steps 8-12)
   ...
   - Survey questions now include (with adjusted progress steps):
     1. Biggest struggle (1/5)
     2. Current learning method (2/5)
     3. Daily goal (3/5)
     4. Proficiency level (4/5)
     5. Cultural interests (5/5)

13. `SurveyInsightsScreen.tsx` (Step 13)
   - Gemini API integration
   - Loading state handling
   - Display of personalized insights

14. `AccountCreationScreen.tsx` (Step 14)
