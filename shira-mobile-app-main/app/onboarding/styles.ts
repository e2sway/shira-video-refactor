...
export const colors = {
    ...
    primary: PURPLE_ACCENT,          // Purple accent color
    secondary: '#47a349',           // Green accent color
    tertiary: '#51e1a2',            // Teal accent color
    accent: '#c4cc45',              // Yellow accent
    
    // Gradient combinations
    gradientPrimary: [PURPLE_ACCENT, `${PURPLE_ACCENT}cc`],  // Purple gradient
    gradientSecondary: ['#47a349', '#68b669'], // Green gradient
    gradientMixed: ['#47a349', PURPLE_ACCENT],    // Green to purple gradient
    gradientCool: [PURPLE_ACCENT, '#51e1a2'],     // Purple to teal gradient
    gradientWarm: [PURPLE_ACCENT, '#c4cc45'],     // Purple to yellow gradient
    ...
    buttonBackground: PURPLE_ACCENT,    // Purple buttons
    buttonDisabled: `${PURPLE_ACCENT}80`,    // Semi-transparent purple
    
    // Progress elements
    progressBarBackground: 'rgba(255, 255, 255, 0.1)',
    progressBarFill: PURPLE_ACCENT,
    
    // Selection elements
    selectionBackground: 'rgba(255, 255, 255, 0.08)',
    selectionBorder: 'rgba(255, 255, 255, 0.12)',
    selectionActive: `rgba(90, 81, 225, 0.2)`,
    selectionActiveBorder: PURPLE_ACCENT,
    
    // Button states
    languageButton: 'rgba(255, 255, 255, 0.08)',  // Semi-transparent white
    languageButtonSelected: `rgba(90, 81, 225, 0.2)`,
    levelButton: 'rgba(255, 255, 255, 0.08)',
    levelButtonSelected: `rgba(90, 81, 225, 0.2)`,
